...
@ApplyOptions<Subcommand.Options>({
	...
	detailedDescription:
		'Search for games or get detailed information about a game using its RAWG ID, not steam ID. When searching, you will be prompted to select from a list of results.',
...
export class Rawg extends Subcommand {
	...
	private async handleGameSearch(
		gameName: string,
		context: {
