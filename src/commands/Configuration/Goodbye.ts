...
@ApplyOptions<Subcommand.Options>({
	...
	detailedDescription:
		'Customizable goodbye message system that announces member departures with personalized messages using dynamic placeholders. Helps maintain community awareness of membership changes and provides closure for member departures.',
	examples: [
