...
@ApplyOptions<Subcommand.Options>({
    ...
    detailedDescription: 'Comprehensive welcome system with customizable messages using dynamic placeholders, channel-specific announcements, and optional direct message greetings. Create a welcoming first impression with personalized content that scales automatically.',
    examples: [
        ...
        { example: 'welcome set Hey {username}, welcome to **{guild}**! Check out <#rules> first.', description: 'Message with channel mentions and formatting.' },
