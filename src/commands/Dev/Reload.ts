        ...
        try {
            switch (type.toLowerCase()) {
                case 'task': {
                    ...
                    embed.setTitle('🔄 Task Reload')
                        .setDescription(success
                            ? `✅ Successfully reloaded task: \`${name}\``
                            : `❌ Failed to reload task: \`${name}\``
                        )
                ...
                case 'tasks': {
                    if (all) {
                        ...
                        embed.setTitle('🔄 All Tasks Reload')
                            .setDescription(`✅ Successfully reloaded: ${results.success} tasks`
                ...
                case 'structure': {
                    ...
                    embed.setTitle('🔄 Structure Reload')
                ...
                case 'listener': {
                    ...
                    if (!listener) {
                        embed.setTitle('❌ Event/Listener Not Found')
                            .setDescription(`Event/Listener \`${name}\` not found.`)
                            .setColor(Colors.Critical)
                    } else {
                        await listener.reload()
                        embed.setTitle('🔄 Event/Listener Reload')
                            .setDescription(`✅ Successfully reloaded event/listener: \`${name}\``)
                            .setColor(Colors.Active)
                    }
                    break
                }
                ...
                case 'load-structure': {
                    ...
                    embed.setTitle('✨ Load New Structure')
                        .setDescription(result.success ? `✅ ${result.message}` : `❌ ${result.message}`)
                        .setColor(result.success ? Colors.Active : Colors.Critical)
                    break
                }
                ...
                case 'blacklist': {
                    ...
                    embed.setTitle('🚫 Hot Reload Blacklist')
