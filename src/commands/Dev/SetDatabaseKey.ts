...
@ApplyOptions<Command.Options>({
    ...
    examples: [
        { example: 'setdatabasekey prefix ! --guild 123456789012345678', description: 'Sets the prefix key to "!" for the specified guild.' }
    ],
...
export class SetDatabaseKey extends Command {
    ...
    private async handleSetKey(key: string, value: string, guildResolvable: string | null, context: {
