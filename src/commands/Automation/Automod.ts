...
@ApplyOptions<Subcommand.Options>({
	...
	detailedDescription:
		'Comprehensive automoderation system with configurable rules for spam, invites, caps, bad words, and attachments. Features automatic punishments and customizable thresholds.',
	examples: [
		...
		registry.registerChatInputCommand((builder) =>
			builder
				...
				.addSubcommand((sub) =>
					sub
						.setName('enable')
						.setDescription('Enable automoderation for this server')
				)
				.addSubcommand((sub) =>
					sub
						.setName('disable')
						.setDescription('Disable automoderation for this server')
				)
				.addSubcommand((sub) =>
					sub
						.setName('status')
						.setDescription('View current automod configuration and rules')
				)
				.addSubcommand((sub) =>
					sub
						.setName('muterole')
						...
						.addRoleOption((option) =>
							option
								.setName('role')
								.setDescription('The role to use for muting')
								.setRequired(false)
						)
					.addBooleanOption((option) =>
						option
							.setName('auto')
							.setDescription('Automatically find mute role')
							.setRequired(false)
					)
				)
				.addSubcommand((sub) =>
