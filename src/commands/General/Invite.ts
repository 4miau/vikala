...
export class Invite extends Command {
	...
	public async messageRun(message: Message) {
		...
		const e = new EmbedBuilder().setTitle('Invite Me').setDescription(`[Invite me to your server](${inviteLink})`)
	...
	public override registerApplicationCommands(registry: Command.Registry) {
		registry.registerChatInputCommand((builder) => builder.setName('invite').setDescription('Sends an invite link for the bot.'))
	}
}
