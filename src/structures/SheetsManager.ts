...
export default class Sheets {
    ...
    private async addGogEntry(gameLink: string, sheetIndex: number) {
        ...
        const releaseDate = game.release_date ? new Date(game.release_date).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' }) : ''
    ...
    private mapRowToGameData(row: GoogleSpreadsheetRow, sheet: GoogleSpreadsheetWorksheet, sheetTitle: string): VHS.LibraryGameEntry | VHS.ArchiveGameEntry {
